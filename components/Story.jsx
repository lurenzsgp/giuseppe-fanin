...
const Story = () =>
{
    return (<TextContainer>
        ...
        <p>Una notte di novembre. È la sera del 4 novembre 1948. Un giovane sta tornando a casa in bicicletta, dopo essersi incontrato con la fidanzata. All'improvviso, lungo la strada che da San Giovanni in Persiceto porta la frazione di Lorenzatico, egli viene aggredito e colpito a morte con una spranga di ferro. Aveva 24 anni. Si chiamava Giuseppe Fanin</p>
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_1.webp" type="image/webp" />
                <source srcSet="static/fanin_1.jpg" type="image/jpg" />
                <Image shrink src="static/fanin_1.jpg" alt="Ritratto di Giuseppe Fanin" />
            </picture>
            <picture>
                <source srcSet="static/fanin_2.webp" type="image/webp" />
                <source srcSet="static/fanin_2.jpg" type="image/jpg" />
                <Image src="static/fanin_2.jpg" alt="Il mucchio di ghiaia in via Biancolina su cui viene ritrovato morente" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_3.webp" type="image/webp" />
                <source srcSet="static/fanin_3.jpg" type="image/jpg" />
                <Image src="static/fanin_3.jpg" alt="Giuseppe nell'aia di fronte a casa in via Tassinara" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_4.webp" type="image/webp" />
                <source srcSet="static/fanin_4.jpg" type="image/jpg" />
                <Image src="static/fanin_4.jpg" alt="Giuseppe e Lidia durante i festeggiamenti del neolaureto con la corona di cipolle" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_5.webp" type="image/webp" />
                <source srcSet="static/fanin_5.jpg" type="image/jpg" />
                <Image shrink src="static/fanin_5.jpg" alt="Giuseppe e Lidia" />
            </picture>
            <picture>
                <source srcSet="static/fanin_6.webp" type="image/webp" />
                <source srcSet="static/fanin_6.jpg" type="image/jpg" />
                <Image src="static/fanin_6.jpg" alt="Giuseppe e Lidia" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_7.webp" type="image/webp" />
                <source srcSet="static/fanin_7.jpg" type="image/jpg" />
                <Image src="static/fanin_7.jpg" alt="Persone in campagna" />
            </picture>
        </ImagesContainer>

        <h2>Giuseppe e l'impegno sociale</h2>
        <p>Ancora universitario, Giuseppe entra nell'associazione dei lavoratori cristiani di Bologna, dedicandosi allo studio dei problemi del mondo agricolo e della dottrina sociale cristiana. Dopo la laurea nonostante altre offerte di lavoro economicamente allettanti, egli preferisce continuare l'impegno dell'associazione, divenendone un dirigente del settore terra: organizza il lavoro, collabora alla progettazione di cooperative agricole operai e promuove la costituzione della sezione territoriale del sindacato libero di ispirazione cristiana. La sua attività appassionata lo porta a tenere incontri in numerosissime località della provincia. Il 7 novembre 1948 avrebbe dovuto presentare un innovativo contratto di compartecipazione dei braccianti in un pubblico convegno organizzato a Molinella con la presenza del sottosegretario dell'Agricoltura. Ma muore due giorni prima ucciso da tre iscritti del PCI locale.</p>
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_8.webp" type="image/webp" />
                <source srcSet="static/fanin_8.jpg" type="image/jpg" />
                <Image src="static/fanin_8.jpg" alt="Giuseppe durante un corso di formazione sindacale" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_9.webp" type="image/webp" />
                <source srcSet="static/fanin_9.jpg" type="image/jpg" />
                <Image src="static/fanin_9.jpg" alt="la chiesa di San Giacomo di Lorenzatico che Giuseppe frequentava" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_10.webp" type="image/webp" />
                <source srcSet="static/fanin_10.jpg" type="image/jpg" />
                <Image src="static/fanin_10.jpg" alt="Commemorazione in piazza a San Giovanni in Persiceto" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_11.webp" type="image/webp" />
                <source srcSet="static/fanin_11.jpg" type="image/jpg" />
                <Image src="static/fanin_11.jpg" alt="Particolari del funerale" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_12.webp" type="image/webp" />
                <source srcSet="static/fanin_12.jpg" type="image/jpg" />
                <Image src="static/fanin_12.jpg" alt="I famigliari all'inaugurazione del cippo in via Biancolina" />
            </picture>
        </ImagesContainer>
        ...
        <ImagesContainer>
            <picture>
                <source srcSet="static/fanin_13.webp" type="image/webp" />
                <source srcSet="static/fanin_13.jpg" type="image/jpg" />
                <Image src="static/fanin_13.jpg" alt="Locandina del film su Giuseppe Fanin" />
            </picture>
        </ImagesContainer>
        <p>A breve si comunicherà come verrà reso disponibile il film (per chi è interessato fare riferimento alla sezione contatti).</p>
